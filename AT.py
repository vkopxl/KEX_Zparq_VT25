...
# Trim-algoritm som optimerar tilt för bästa effektivitet (Gradient Ascent), har alternativet momentum gradient ascent.
    def __init__(self, can_interface, csv_logger, step_size= 200, tolerance=0.000004, max_iterations=100, alpha= 1000000, beta=0.98, v=0, use_momentum=False, fake = False, sim = False):
