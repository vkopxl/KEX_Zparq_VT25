...
# Klass som hanterar CAN-kommunikation
    ...
    def read_only_mode(self, csv_logger = None, log = False, skriv = False):
...
# Trim-algoritm som optimerar tilt för bästa effektivitet (Gradient Ascent), har alternativet momentum gradient ascent.
    def __init__(self, can_interface, csv_logger, step_size=100, tolerance=0.00002, max_iterations=100, alpha=0.1, beta=0.9, v=0, use_momentum=False):
